...
declare type ValidatorSchemaOptions<K extends keyof Validators<any>> =
  | true
  | {
      options?:
        | Parameters<Validators<any>[K]>
        | Parameters<Validators<any>[K]>[0];
...
declare type SanitizerSchemaOptions<K extends keyof Sanitizers<any>> =
  | true
  | {
      options?:
        | Parameters<Sanitizers<any>[K]>
        | Parameters<Sanitizers<any>[K]>[0];
    };
...
): import('express-validator/src/chain').ValidationChain[];
export {};
